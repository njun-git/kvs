...
#ifndef KVS__OPENNI__SCREEN_CONTROLLER_H_INCLUDE
#define KVS__OPENNI__SCREEN_CONTROLLER_H_INCLUDE
...
class HandPosition
{
    ...
    // Class name.
    kvsClassName( kvs::ni::ScreenController );
...
class ScreenController
{
    ...
    typedef std::list<kvs::ni::HandPosition> HandList;
...
public:
    ...
    ScreenController( kvs::ScreenBase* screen );
